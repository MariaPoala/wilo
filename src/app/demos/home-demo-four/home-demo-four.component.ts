...
@Component({
    ...
    standalone: true,
    imports: [NavbarComponent, BannerComponent, FeaturedServicesComponent, WhyChooseUsComponent, WhatWeDoComponent, FunfactsComponent, ServicesComponent, TestimonialsComponent, IndustriesComponent, TeamComponent, CaseStudiesComponent, BlogComponent, GetStartedComponent, FooterComponent],
